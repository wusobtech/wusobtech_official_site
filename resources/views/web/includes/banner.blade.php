            ...
            <div class="container">
                <div class="row banner-w3layouts-grids">
                    ...
                    <div class="col-lg-6 banner-w3layouts-image">
                        <div class="effect-w3">
                            <img src="{{ asset('web/images/img.jpg') }}" alt="" class="img-fluid image1">
                            <img src="{{ asset('web/images/img.jpg') }}" alt="" class="img-fluid image2">
                            <img src="{{ asset('web/images/img.jpg') }}" alt="" class="img-fluid image3">
                            <img src="{{ asset('web/images/img.jpg') }}" alt="" class="img-fluid image4">
                        </div>
